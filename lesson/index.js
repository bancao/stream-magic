...
// 示例图片
const sampleImage1 = '/lesson/assets/sampleImage1.jpg'
// 画布最大宽度
const maxCanvasWidth = 375
// wasm路径
global.wasm_url = '/lesson/assets/opencv3.4.16.wasm.br'
// opencv_exec.js会从global.wasm_url获取wasm路径
let cv = require('../lesson/assets/opencv_exec.js');

//video1
const sampleVideo = "/lesson/assets/videos"
Page({
	// 画布的dom对象
	canvasDom: null,
	data: {
